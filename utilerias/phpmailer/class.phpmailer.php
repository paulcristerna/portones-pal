...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'soporte@pal.com.mx';
   ...
   * @var string
   */
  public $Username     = 'soporte@pal.com.mx';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password     = 'soporte123654';
   ...
   * @return bool
   */
  function SetLanguage($lang_type = 'es', $lang_path = 'language/') {
